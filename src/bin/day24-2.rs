...
fn main() {
    ...
    let step1 = bfs(start, end, height, width, &blizzards, 0);
    println!("{}", step1);
    let step2 = bfs(end, start, height, width, &blizzards, step1);
    println!("{}", step2);
    let step3 = bfs(start, end, height, width, &blizzards, step2);
    println!("{}", step3);
}
